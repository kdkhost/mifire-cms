    ...
    <footer class="bg-gray-900 text-gray-300">
        <div class="max-w-7xl mx-auto px-4 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                {{-- Col 2: Endereços vs Fale Conosco --}}
                @php
                    $physicalAddresses = $addresses->filter(fn($a) => !empty($a->address) && strlen($a->address) > 5);
                    $contactDepartments = $addresses->filter(fn($a) => empty($a->address) || strlen($a->address) <= 5);
                @endphp
                ...
                <div>
                    ...
                    <div class="space-y-6 text-sm">
                        @foreach($physicalAddresses as $address)
                            <div class="border-l-2 border-red-600 pl-4 py-1">
                                <h4 class="text-white font-semibold mb-1">{{ $address->label }}</h4>
