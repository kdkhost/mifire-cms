...
<div x-data="pageForm()">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Crie uma nova página para o site</p>
        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <textarea name="content" id="content" rows="12"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500"
                              placeholder="Conteúdo da página...">{{ old('content') }}</textarea>
...
<script>
    function pageForm() {
        return {
            ...
            generateSlug() {
                if (!this.slug || this.slug === this.previousSlug) {
