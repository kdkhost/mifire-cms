...
<div x-data="categoryForm()">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Crie uma nova categoria</p>
        </div>
        <a href="{{ route('admin.categories.index') }}" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="type" id="type" required
                                ...
                                <option value="product" {{ old('type') == 'product' ? 'selected' : '' }}>Produtos</option>
                                <option value="blog" {{ old('type') == 'blog' ? 'selected' : '' }}>Blog</option>
                                <option value="download" {{ old('type') == 'download' ? 'selected' : '' }}>Downloads</option>
                            </select>
                            @error('type') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label for="parent_id" class="block text-sm font-medium text-gray-700 mb-1">Categoria Pai</label>
