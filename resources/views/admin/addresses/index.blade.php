            ...
            @forelse($addresses as $address)
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 relative group">
                    <div class="flex items-start justify-between mb-3">
                        ...
                        <span
                            class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium {{ $address->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600' }}">
                    ...
                    <div class="flex items-center gap-2 border-t border-gray-100 pt-3">
                        <a href="{{ route('admin.addresses.edit', $address) }}"
                            class="flex-1 text-center px-3 py-1.5 text-sm text-blue-600 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                            Editar
                        </a>
