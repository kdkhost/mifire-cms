        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1" style="max-height: calc(100vh - 4rem);">
            @php
                $navItems = [
                    ...
                    ['route' => 'admin.whatsapp-widget.index', 'label' => 'Atendimento Widget', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"/>'],
